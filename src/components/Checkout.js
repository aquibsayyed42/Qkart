            ...
            <Box>
              {addresses.all.length ? (
                addresses.all.map((item) => (
                  <>
                  <Box className={addresses.selected === item._id ? "address-item selected" : "address-item not-selected"}
                  onClick={() => {
                    setAddresses({
                      ...addresses,
                      selected: item._id,
                  ...
                  <input
                    type="radio"
                    className="radio"
                    checked={addresses.selected === item._id}
                  />
                    <Typography  sx={{ flexGrow: 1 }} ml={1.5}>{item.address}</Typography>
                  <Button
                      id="add-new-btn"
                      startIcon={<Delete />}
                      onClick={async () => {
